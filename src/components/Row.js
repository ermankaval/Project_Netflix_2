    ...
    return (
        <div className='space-y-0.5 md:space-y-2'>
            ...
            <div className='group relative md:ml-2'>
                <BiChevronLeft className='absolute top-0 bottom-0 left-2 z-40 m-auto h-9 w-9
                cursor-pointer opacity-0 transition hover:scale-125 group-hover:opacity-100'
                    onClick={() => handleClick("left")} />

                <div
                    className='flex items-center space-x-0.5 scrollbar-hide overflow-x-scroll md:spacex-2.5 md:p-2'
                    ref={rowRef}
                >
                    {movies.map((movie) => (
                ...
                <BiChevronRight className='absolute top-0 bottom-0 right-2 z-40 m-auto h-9 w-9
                cursor-pointer opacity-0 transition hover:scale-125 group-hover:opacity-100'
